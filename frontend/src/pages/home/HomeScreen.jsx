...
//           alt="Hero img" className="absolute top-0 w-full h-full object-cover -z-50"
//           onLoad={() => {
...
//               trendingContent?.first_air_date.split('-')[0]}{" "} | 18+
//             </p>
...
//               className="bg-white hover:bg-white/80 text-black font-bold py-2 px-4 
